...
<form name="cart" method="post">	
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					<th class="cart-romove item">Bil</th>					
...
if($num>0)
{
$query=mysqli_query($con,"select products.productName as pname,orders.productId as opid,orders.quantity as qty,products.productPrice as pprice,products.shippingCharge as pcode,orders.orderDate as odate,orders.id as orderid from orders join products on orders.productId=products.id where orders.id='$orderid' and orders.paymentMethod is not null");
$cnt=1;
...
?>
				<tr>
					...
					<td class="cart-product-sub-total"><?php echo $row['pcode']; ?>  </td>
